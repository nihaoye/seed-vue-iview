...
var username = process.env.TEST_USER || process.env.USER
var apiRootPrefix = username === 'local' ? '' : (username + '.')

var webpackConfig = merge(baseWebpackConfig, {
  watch: process.env.NO_WATCH == 1 ? false : true,
  module: {
  ...
  plugins: [
    ...
    new webpack.DefinePlugin({
      ...
      USER_NAME: JSON.stringify(process.env.TEST_USER || process.env.USER),
      API_ROOT: JSON.stringify('https://' + apiRootPrefix + 'danpin.toutiao.com')
    }),
